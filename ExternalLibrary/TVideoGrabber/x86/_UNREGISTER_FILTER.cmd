...
rem 
rem              Directshow filters unregistration utility
rem                            v2.3.161003
rem 
...
FOR %%A IN ("Datastead*.ax") DO (
   regsvr32.exe /s /u "%CURDIR%%%A"
   if NOT ERRORLEVEL 1 ECHO %%A successfully UNregistered.
   if ERRORLEVEL 1 ECHO !FAILED TO UNREGISTER %%A
)
